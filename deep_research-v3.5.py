...
class DeepResearchTool:
    ...
    def _setup_tools(self):
        ...
        scholar_api = GoogleScholarAPIWrapper(serp_api_key=os.getenv("SERP_API_KEY"))
        scholar = GoogleScholarQueryRun(api_wrapper=scholar_api)
        wolfram_alpha_api = WolframAlphaAPIWrapper(wolfram_alpha_appid=os.getenv("WOLFRAM_ALPHA_APPID"))  # Updated parameter name
    ...
    def _create_agent(self):
        prompt = ChatPromptTemplate.from_messages([
            ...
            **Output Format:**
            ...
            ("human", "{query}"),
            ("ai", "{agent_scratchpad}")  # Added agent_scratchpad message
        ])

...
class DeepResearchTool:
    ...
    def _setup_tools(self):
        ...
        scholar_api = GoogleScholarAPIWrapper(serp_api_key=os.getenv("SERP_API_KEY"))  # Updated to use SERP API key from env
        scholar = GoogleScholarQueryRun(api_wrapper=scholar_api)  # Pass wrapper to query runner
